...
export const YelpActionTypes = {
    ...
    FETCH_RESTAURANT_REVIEWS_START: 'FETCH_RESTAURANT_REVIEWS_START',
    FETCH_RESTAURANT_REVIEWS_SUCCESS: 'FETCH_RESTAURANT_REVIEWS_SUCCESS',
    FETCH_RESTAURANT_REVIEWS_ERROR: 'FETCH_RESTAURANT_REVIEWS_ERROR'
};
...
export const fetchRestaurantReviewsActionTypes = toFetchActionTypes([
    YelpActionTypes.FETCH_RESTAURANT_REVIEWS_START,
    YelpActionTypes.FETCH_RESTAURANT_REVIEWS_SUCCESS,
    YelpActionTypes.FETCH_RESTAURANT_REVIEWS_ERROR
]);